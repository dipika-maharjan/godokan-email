...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["components","vendor-button"]},{"slug":["customers","welcome.customer"]},{"slug":["layouts","customer.layout"]},{"slug":["layouts","vendor.layout"]},{"slug":["samples","notion-magic-link"]},{"slug":["samples","plaid-verify-identity"]},{"slug":["samples","stripe-welcome"]},{"slug":["samples","vercel-invite-user"]},{"slug":["vendors","account-approved.vendor"]},{"slug":["vendors","add-business-detail.vendor"]},{"slug":["vendors","add-products.vendor"]},{"slug":["vendors","business-details-status.vendor"]},{"slug":["vendors","order-mail.vendor"]},{"slug":["vendors","payout-request-statement.vendor"]},{"slug":["vendors","payout-request-status.vendor"]},{"slug":["vendors","payout-request.vendor"]},{"slug":["vendors","product-questions.vendor"]},{"slug":["vendors","product-review.vendor"]},{"slug":["vendors","products-approved.vendor"]},{"slug":["vendors","seller-account-verification-status.vendor"]},{"slug":["vendors","signup.vendor"]},{"slug":["vendors","start-selling.vendor"]},{"slug":["vendors","verify-email.vendor"]}]
  );
}