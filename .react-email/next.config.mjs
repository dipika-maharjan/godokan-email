...
const userProjectLocation = 'E:/godokan-email/godokan-email';
const previewServerLocation = 'E:/godokan-email/godokan-email/.react-email';
const rootDir = 'E:/godokan-email/godokan-email';
